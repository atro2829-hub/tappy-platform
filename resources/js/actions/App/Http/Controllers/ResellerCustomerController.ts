...
/**
* @see \App\Http\Controllers\ResellerCustomerController::index
...
const ResellerCustomerController = { index, store, importMethod, update, destroy, import: importMethod }

export default ResellerCustomerController